...
import 'package:rsvg_app/customisation/tab_bar.dart';
import 'package:rsvg_app/customisation/text_customisation.dart';

class BusinessDetailApplication extends StatefulWidget {
  const BusinessDetailApplication({Key key}) : super(key: key);

  @override
  _BusinessDetailApplicationState createState() =>
      _BusinessDetailApplicationState();
}

class _BusinessDetailApplicationState extends State<BusinessDetailApplication> {
  @override
